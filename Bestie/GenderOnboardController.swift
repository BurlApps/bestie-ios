...
class GenderOnboardController: OnboardPageController, VoterImageSetDelegate {
    ...
    func setFinished(set: VoterImageSet, image: Image) {
        self.onboardController.user.changeGender(image.gender)
